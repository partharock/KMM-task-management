...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class DecomposeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Group of libraries at <b>decompose.extensions</b>
         */
        public DecomposeExtensionsLibraryAccessors getExtensions() {
            return laccForDecomposeExtensionsLibraryAccessors;
        }
    ...
    public static class DecomposeExtensionsLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>compose</b> with <b>com.arkivanov.decompose:extensions-compose-jetbrains</b> coordinates and
         * with version reference <b>decompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
            return create("decompose.extensions.compose");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>decompose</b> with value <b>3.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>room</b> with value <b>2.7.0-alpha01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KoinVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>koin.compose</b> with value <b>+</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
